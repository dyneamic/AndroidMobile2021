package id.ac.umn.week13_28280;
                    ...
                    case 1:
                        ...
                        if (mMap != null) {
                            ...
                            if (rad.length() > 0 && Double.parseDouble(rad) > 0.0) {
                                ...
                                mMap.addCircle(new CircleOptions().radius(radius).center(titiks.get(0))
                                        .strokeColor(Color.YELLOW).fillColor(Color.argb(30, 255, 255, 0)));
