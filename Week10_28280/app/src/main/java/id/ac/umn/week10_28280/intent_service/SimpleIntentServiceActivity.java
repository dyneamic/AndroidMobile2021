...
public class SimpleIntentServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent servIntent = new Intent(SimpleIntentServiceActivity.this, SimpleIntentService.class);
        ...
        btnStartService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SimpleIntentServiceActivity.this, CustomService.class);
                startService(intent);
            }
        });

        Intent intent2 = new Intent(SimpleIntentServiceActivity.this, CustomBoundService.class);
